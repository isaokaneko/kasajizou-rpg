...
class akudaikan1:
    ...
    def hit(self,screen,background1,enemy,y):
        ...
        #time.sleep(1)
        list1.append("Akudaikan no kougeki")
        a = f + self.tuyosa
...
class jizouclass:
    ...
    def taosita(self,screen,background1,enemy,y):
        ...
        font_height = font.get_linesize()
        screen.blit(background1,(0,0))
        list1.append(enemy.name + " wo taosita!!!")
        list1.append("")
        for text in reversed(list1):
            screen.blit(font.render(text,True,(255,255,255)),(200,300-y))
            y += font_height
    ...
    def tao3(self,screen,background1,teki,y):
        ...
        print(list1)
        print("CCC")
        list1.append(teki.name + " wo taosita")
    ...
    def del1(self,list1):
        del list1[:]
        print list1
    def levelup(self,screen,background1,jj,enemy,y):
        if jj.keikenchi >= 60 and jj.level == 1 or jj.level == 0:

            jj.maxhp = jj.maxhp + int((3 * random.random())) + 10
            jj.tuyosa = jj.tuyosa +  int((3 * random.random())) + 5
            screen.blit(background1,(0,0))
            list1.append("jizou no levelup 2")
            font = pygame.font.Font(None,32)
            font_height = font.get_linesize()
            for text in reversed(list1):
                screen.blit(font.render(text,True,(255,255,255)),(200,300-y))
            ...
            jj.maxhp = jj.maxhp + int((3 * random.random())) + 20
            jj.tuyosa = jj.tuyosa +  int((3 * random.random())) + 10
            screen.blit(background1,(0,0))
            list1.append("jizou no levelup 3")
            font = pygame.font.Font(None,32)
            font_height = font.get_linesize()
            for text in reversed(list1):
                screen.blit(font.render(text,True,(255,255,255)),(200,300-y))
                y += font_height
            jj.level=3
        elif jj.keikenchi >= 600 and jj.level == 3:
            jj.maxhp = jj.maxhp + int((3 * random.random())) + 30
            jj.tuyosa = jj.tuyosa +  int((3 * random.random())) + 20
            screen.blit(background1,(0,0))
            list1.append("jizou no levelup 4")
            font = pygame.font.Font(None,32)
            font_height = font.get_linesize()
            for text in reversed(list1):
                screen.blit(font.render(text,True,(255,255,255)),(200,300-y))
...
class tesita1:
    ...
    def hit(self,screen,background1,enemy,y):
        ...
        screen.blit(background1,(0,0))
        #time.sleep(1)
        list1.append(self.name + " no kougeki")
        a = f + self.tuyosa
...
def sentou(teki):
    ...
    while True:
        ...
        text = font.render("Keikenchi",False,(255,255,255))
