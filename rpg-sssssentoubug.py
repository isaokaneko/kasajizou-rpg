...
class jizouclass:
    ...
    def levelup(self,screen,background1,enemy,y):
        if jj.keikenchi >= 60:
            ...
            jj.tuyosa = jj.tuyosa +  int((3 * random.random()))
            screen.blit(background1,(0,0))
...
class tesita1:
    ...
    def tao2(self,screen,background1,jj,y):
        ...
        for text in reversed(list1):
            ...
            y += font_height
        return list1
        jj.keikenchi = jj.keikenchi + tesitajj.keikenchiout
        xy = [x,y]
        sss(self,xxx,yyy)
...
def field(basho):
    ...
    while True:
       ...
       #screen.fill((0,0,0))
        ...
        print(xxx,yyy,"jfjkdlksjf",cccc,ssss,jj.keikenchi,levjj)
        ...
        if playerpos == 0:
            ...
            if pressed[K_RETURN]:
                ...
                if teki.hp <=0:
                    ...
                    levjj = (jj.maxhp,jj.tuyosa)
                    if jj.keikenchi >= 90 and jj.tttt == 1:
                        jj.levelup(screen,background,teki,y)
                        jj.tttt = 0
                    elif jj.keikenchi >= 500 and jj.tttt == 1:
                        jj.levelup(screen,background,teki,y)
                        jj.tttt = 0
